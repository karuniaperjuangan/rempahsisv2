...
class Article {
  ...
  List<int> tags;
  List<dynamic> acf;
  List<dynamic> postMailingQueueIds;
  Links links;
  ...
  Article({
    ...
    required this.tags,
    required this.acf,
    required this.postMailingQueueIds,
    required this.links,
  });
  ...
  factory Article.fromJson(Map<String, dynamic> json) => Article(
        ...
        postMailingQueueIds:
            List<dynamic>.from(json["post_mailing_queue_ids"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "post_mailing_queue_ids":
            List<dynamic>.from(postMailingQueueIds.map((x) => x)),
        "_links": links.toJson(),
      };
}
