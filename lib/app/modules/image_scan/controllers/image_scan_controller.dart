...
class ImageScanController extends GetxController {
    ...
    if (image != null) {
      ...
      if (maxIndex != null) {
        ...
        classificationResult.value =
            rempahs.firstWhere((element) => element.id == maxIndex).namaRempah;
  ...
  Future<int?> classifyImage(File image) async {
    ...
    final rawAssetFile2 =
        await rootBundle.load('assets/rempahsis_model_map.json');
  ...
  Future<List<double>> imageToFloatTensor(File image) async {
    ...
    return [
      ...indexed
          .where((e) => e.$1 % 3 == 0)
          .map((e) => e.$2 / 255), // Red channel
      ...indexed
          .where((e) => e.$1 % 3 == 1)
          .map((e) => e.$2 / 255), // Green channel
      ...indexed
          .where((e) => e.$1 % 3 == 2)
          .map((e) => e.$2 / 255) // Blue channel
    ];
  }
}
