      ...
      body: SingleChildScrollView(
        child: Obx(()=> Container(
                  decoration: BoxDecoration(
                    image: DecorationImage(image: AssetImage('assets/images/rempah/' +
                                  controller.rempah.value.gambar),fit: BoxFit.contain, alignment: Alignment.topCenter)
                  ),
                  child: Column(
                    children: [
                      SizedBox(height: 200),
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Flexible(
                                        child: MarkdownBody(
                                          data: controller.rempah.value.ikhtisar,
                                          styleSheet: MarkdownStyleSheet(
                                              p: TextStyle(
                                  ...
                                  ExpandableInformation(
                                      ...
                                      ref: controller.rempah.value.referensiMorfologi),
                                  ExpandableInformation(
                                      title: "Ciri-Ciri",
                                      info: controller.rempah.value.ciri,
                                      ref: controller.rempah.value.referensiCiri
                                      ),
                                  ExpandableInformation(
                                      title: "Khasiat",
                                      info: controller.rempah.value.khasiat,
                                      ref: controller.rempah.value.referensiKhasiat
                                  ),
                                  ExpandableInformation(
                                      title: "Kegunaan",
                                      info: controller.rempah.value.kegunaan,
                                      ref: controller.rempah.value.referensiKegunaan
                                      ),
                                  ExpandableInformation(
                                      title: "Potensi",
                                      info: controller.rempah.value.potensi,
                                      ref: controller.rempah.value.referensiPotensi
                                      ),
                                ],
                              ),
                            )
...
class ExpandableInformation extends StatelessWidget{
  const ExpandableInformation({super.key, 
      required this.title,
      required this.info,
      required this.ref});
  ...
  void referensi(BuildContext context, String ref) {
    showModalBottomSheet(
      ...
      builder: (BuildContext bc) {
        var controller = Get.find<RempahDetailController>();
